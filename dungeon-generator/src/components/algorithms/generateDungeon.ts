...
export const generateDungeon = (
  numberOfRooms: number, seed: string, _corridorType: 'astar', allowDiagonalCorridors: boolean, manualRooms?: RoomSpecifics[]
): { roomSpecifics: RoomSpecifics[]; map: DungeonMapMatrix; triangulation: Triangle[]; mstEdges: Array<{start: Point, end: Point}>} => {
  ...
  return { roomSpecifics, map: mapWithRoomsAndCorridors, triangulation: triangles, mstEdges };
}
